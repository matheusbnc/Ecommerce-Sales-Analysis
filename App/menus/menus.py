...
def sazonalidade_submenu():
    ...
    print('='*80)
    print('1. Variação Diária [Unidades]')
    print('2. Variação Diária [Valor (£)]')
    print('3. Variação Diária [Ocorrências]')
    print('4. Variação Mensal [Unidades]')
    print('5. Variação Mensal [Valor (£)]')
    print('6. Variação Mensal [Ocorrências]')
    print('7. Variação Trimestral [Unidades]')
    print('8. Variação Trimestral [Valor (£)]')
    print('9. Variação Trimestral [Ocorrências]')
    print('='*80)
    print('0. Voltar ao Menu Principal')
