...
def sazonalidade_submenu():
    ...
    print('='*80)
    print('1. Variação Diária de Vendas/Cancelamentos [Unidades]')
    print('2. Variação Mensal de Vendas/Cancelamentos [Valor (£)]')
    print('3. Variação Trimestral de Vendas/Cancelamentos [Ocorrências]')
    print('='*80)
    print('0. Voltar ao Menu Principal')
